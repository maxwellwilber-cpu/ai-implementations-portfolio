...
- Baseline Claude without the skill averaged 50.3 s on the same task, so the skill runs 44% faster.
...
For work of mine that can be verified by running it, see
[client-data-cleaner](https://github.com/maxwellwilber-cpu/client-data-cleaner),
[checkpoint](https://github.com/maxwellwilber-cpu/checkpoint) and
[evs](https://github.com/maxwellwilber-cpu/evs).
